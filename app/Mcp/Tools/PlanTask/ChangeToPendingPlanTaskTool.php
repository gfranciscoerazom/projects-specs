...
#[Description('A tool that changes a plan task status to pending.')]
class ChangeToPendingPlanTaskTool extends Tool
{
    public function handle(Request $request, ChangeToPendingPlanTask $changeToPending): ResponseFactory
    {
