...
#[Description('A tool that changes a feature status to in progress.')]
class ChangeToInProgressFeatureTool extends Tool
{
    public function handle(Request $request, ChangeToInProgressFeature $changeToInProgress): ResponseFactory
    {
