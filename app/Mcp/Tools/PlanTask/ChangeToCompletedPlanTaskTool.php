...
#[Description('A tool that changes a plan task status to completed.')]
class ChangeToCompletedPlanTaskTool extends Tool
{
    public function handle(Request $request, ChangeToCompletedPlanTask $changeToCompleted): ResponseFactory
    {
