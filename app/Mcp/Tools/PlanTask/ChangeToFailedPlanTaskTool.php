...
#[Description('A tool that changes a plan task status to failed.')]
class ChangeToFailedPlanTaskTool extends Tool
{
    public function handle(Request $request, ChangeToFailedPlanTask $changeToFailed): ResponseFactory
    {
