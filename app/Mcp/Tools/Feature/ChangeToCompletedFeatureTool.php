...
#[Description('A tool that changes a feature status to completed.')]
class ChangeToCompletedFeatureTool extends Tool
{
    public function handle(Request $request, ChangeToCompletedFeature $changeToCompleted): ResponseFactory
    {
